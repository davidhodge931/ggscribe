...
#'   to anchor the spacer. Defaults to `NULL`, which places a single invisible
#'   label at the midpoint of the scale — the middle level for discrete scales,
#'   or the mean of the limits for continuous scales.
