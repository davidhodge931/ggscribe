...
* `sec_axis_annotate` adjusts space in the plot, whereas `annotate_*` functions do not.
...
* Where you require annotation text along a axis with different angles etc, use a combination of `sec_axis_annotate` and `annotate_*` functions. The `sec_axis_annotate` function should include the annotation that requires the maximum space that you want the plot to adjust to. 
