...
that defaults to making transparent ticks and lines and making the text
the same colour as the plot background fill from the set theme.

## Usage

``` r
guide_sec_axis_spacer(..., theme = NULL)
```
